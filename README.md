# Инструкция по использованию реле

## Назначение
Данное устройство позволяет управлять режимами реле с помощью одной кнопки, перебирая все возможные комбинации интервалов включения и выключения.
